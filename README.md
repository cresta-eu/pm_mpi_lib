...
The parameter, nstep, allows the client to label each set of counter values that are output by rank 0. The output file comprises lines of space-separated fields. A description of each field follows (the C-language data type is given in square brackets).
